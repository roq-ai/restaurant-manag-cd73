...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Restaurant management software`}</title>

        <meta
          name="description"
          content="Welcome to Restaurant Management Software, your ultimate solution for seamless restaurant operations. Streamline processes, enhance customer experience, and boost your business growth with us."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50fGVufDB8fHx8MTY5NTYzOTg3MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Management Software, your ultimate solution for seamless restaurant operations. Streamline processes, enhance customer experience, and boost your business growth with us.`}
            </Text>
            <Box
