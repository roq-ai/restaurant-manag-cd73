...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create.create': { roles: ['owner', 'manager'], key: 'bookingId', tenantPath: [], userPath: [] },
  'payment.receive.update': { roles: ['owner', 'manager'], key: 'paymentId', tenantPath: [], userPath: [] },
  'feedback.create.create': { roles: ['owner', 'manager'], key: 'feedbackId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['owner', 'manager'];
